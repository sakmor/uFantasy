...
public class HighlightsFX : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        m_highlightMaterial = new Material(Resources.Load("shader/Highlight") as Shader);
        m_blurMaterial = new Material(Resources.Load("shader/MobileBlur") as Shader);
    ...
    private void RecreateCommandBuffer()
    {
        ...
        foreach (var collection in m_objectRenderers)
        {
            ...
            foreach (var render in collection.Key)
            {
                ...
                m_commandBuffer.DrawRenderer(render, m_highlightMaterial, 1, (int)collection.Value.sortingType);
            }
        }
        ...
        foreach (var collection in m_objectExcluders)
        {
            foreach (var render in collection)
            {
                ...
                m_commandBuffer.DrawRenderer(render, m_highlightMaterial, 1, (int)SortingType.Overlay);
            }
        }
